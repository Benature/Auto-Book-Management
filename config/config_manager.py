...
class ConfigManager:
    ...
    def _validate_config(self) -> None:
        ...
        """
        required_sections = ['douban', 'database', 'calibre', 'zlibrary', 'schedule', 'lark', 'logging', 'system']
        ...
        for field in ['username', 'password', 'format_priority', 'download_dir']:
    ...
    def get_database_url(self) -> str:
        ...
        if db_config['type'] == 'sqlite':
            ...
            if not db_path.is_absolute():
                db_path = Path(os.path.dirname(os.path.abspath(self.config_path.as_posix()))) / db_path
    ...
    def get_download_dir(self) -> Path:
        ...
        if not download_dir.is_absolute():
            download_dir = Path(os.path.dirname(os.path.abspath(self.config_path.as_posix()))) / download_dir
        return download_dir
    ...
    def get_temp_dir(self) -> Path:
        ...
        if not temp_dir.is_absolute():
            temp_dir = Path(os.path.dirname(os.path.abspath(self.config_path.as_posix()))) / temp_dir
        return temp_dir